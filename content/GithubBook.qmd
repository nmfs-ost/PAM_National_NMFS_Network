...
1.  Prepare to do Great Things!

    1.   Load Software: [Github Desktop](https://desktop.github.com/)

    2.  Load Software: [RStudio](https://www.rstudio.com/products/rstudio/download/#download) (v2022.07.2 build 576 or later)

    3.  Load Software: [R](https://www.r-project.org/)
